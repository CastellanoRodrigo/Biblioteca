...
Public Class frmConsultaPais
    Private Sub btnListar_Click(sender As Object, e As EventArgs) Handles btnListar.Click
        Try
            ...
            If DR.HasRows Then
                ...
                Do While DR.Read
                    If DR("IdPais") = CmbPais.SelectedValue And DR("Cantidad") > 0 Then
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        ...
        End Try
    End Sub
    Private Sub FrmConsultaLibrosPais_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Conexion.ConnectionString = CadenaDeConexion
            Conexion.Open()
    ...
    Private Sub DocumentoImprimir_PrintPage(sender As Object, e As PrintPageEventArgs) Handles DocumentoImprimir.PrintPage
        ...
        Dim titulo As String = "Pais de origen :  " & CmbPais.Text
        Dim NombrePais = ""
        Dim NombreIdioma = ""
        Dim total As Decimal = 0
