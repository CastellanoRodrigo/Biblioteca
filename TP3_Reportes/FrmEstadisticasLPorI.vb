...
Public Class FrmEstadisticasLPorI
    Private Sub btnListar_Click(sender As Object, e As EventArgs) Handles btnListar.Click
        Try
            ...
            Comando.CommandText = "TitulosPorIdioma"
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Try
            Dim AD As New StreamWriter("EstadisticasPorIdioma.CSV", False, Encoding.Default)

            AD.Write("Nombre del Idioma")
            AD.Write(";")
    ...
    Private Sub DocumentoImprimir_PrintPage(sender As Object, e As PrintPageEventArgs) Handles DocumentoImprimir.PrintPage
        ...
        Dim titulo As String = "Estadisticas por idioma "

        e.Graphics.DrawString(titulo, LetraTitulo, Brushes.Black, 80, 40)
        e.Graphics.DrawString("IdIdioma", LetraTituloColumna, Brushes.Black, 240, 80)
